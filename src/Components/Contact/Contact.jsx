            ...
            <div className="contact-content">
              ...
              <div className="contact-intro-text">
                ...
                <p className="contact-text">
                  ...
                  finding the right service, or want to explore a collaboration,
                ...
                <div className="card-main">
                  ...
                  <div className="bottom-card-link">
                    ...
                    <div className="card-socials">
                      <a
                        key=""
                        href="https://www.instagram.com/coreal8.ng"
                        target="_blank"
                      ...
                      <a
                        key=""
                        href="https://www.linkedin.com/company/coreal8-limited"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="social-link"
                      >
            ...
            <div className="contact-form-container">
              <div className="contact-form">
                ...
                <h4 className="form-subtitle">
                  We respond to all inquiries within 24–48 business hours. If
