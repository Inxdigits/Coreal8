      ...
      <div className="page-content">
        <section className="f1ex flex-col items-center justify-center gap-3 p-20 relative bg-[#80132314] services-header">
          ...
          <p>
            ...
            development. Wherever you are in your journey, there’s a path
            designed for you.
          </p>
        </section>
        ...
        <section className="individual-section consulting-section">
          ...
          <div className="consulting individual">
            ...
            <p>
              ...
              <br />
              <br />
              We help organizations thrive through customized training,
              leadership development, and strategic team solutions that enhance
              culture, performance, and collaboration.
            </p>
            <div className="individual-flex">
              <svg
                width="20"
