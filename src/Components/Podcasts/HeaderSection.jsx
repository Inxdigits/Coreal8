  ...
  return (
    <header className="flex items-center justify-between category-header">
        ...
        {categories.map((category) => (
          <button
            ...
            className={`sort-tile items-center justify-center gap-2.5 px-5 py-2.5 mt-[-1.00px] mb[-1.00px] rounded-[15px] overflow-hidden border border-solid inline-flex relative flex-[0_0_auto] transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-offset-2 focus:ring-[#801323] focus:ring-opacity-50 bg-white ${
              category.id === "all" ? "ml-[-1.00px]" : ""
            } ${
              category.id === "legacy" ? "mr-[-1.00px]" : ""
            } rounded-[15px] overflow-hidden border border-solid transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
              selectedCategory === category.value
                ? category.value === "Leadership"
                  ? "border-[#801323] bg-transparent"
                  : "bg-white border-[#0d0c121a"
      ...
      <div className="flex gap-4 sort">
        <label
          className="content-center relative w-fit [font-family: 'Schibsted_Grotesk-Regular', Helvetica] font-normal text-[#0d0c12] text-base text-center tracking-[0] leading-[normal] align-middle"
        ...
        <div className=" relative flex items-center justify-center sort-btn">
          <button
            ...
            className="content-center flex flex-row gap-2.5 relative w-fit [font-family: 'Schibsted_Grotesk-Regular', Helvetica] font-normal text-[#0d0c12] text-base text-center tracking-[0] leading-[normal]"
          ...
          >
            ...
            <div
              className={`relative transition-transform overflow-hidden duration-200 ${
