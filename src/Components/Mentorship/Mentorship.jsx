    ...
    <>
      ...
      <section className="co-payment-options flex-column">
        <div className="copo-heading">
          ...
          <p>
            We believe in clear and straightforward pricing for our high-quality
            counseling services. <br /> Our fee structure is as follows:
          </p>
        </div>
        ...
        <div className="co-payment-info">
          ...
          <p>
            ...
            Sessions cancelled with less than 24-hour notice will be subject to
            a 50% charge. This allows us to offer the slot to other clients in
            need.
          </p>
        </div>
      </section>
